            ...
            <div class="col-md-6 col-xl-5 mb-4">
                ...
                <div class="card">
                    ...
                    <h5 class="card-header info-color white-text text-center py-4">
                        <strong>Inscription Administrateur Principal</strong>
                    </h5>
                    ...
                    <div class="card-body px-lg-5 pt-0">
                        ...
                        <form class="text-center" style="color: #757575;" method="post"  autocomplete="off">
                            ...
                            <div class="md-form">
                                ...
                                <label for="pseudo">Pseudo ou Nom d&apos;utilisateur</label>
                            </div>
                            ...
                            <div class="md-form">
                                ...
                                <label for="materialLoginFormPassword">Choisir Mot de passe</label>
                                                        ...
                                                        <!-- Sign in button -->
                            <button class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit" name="signup">S'inscrire</button>
